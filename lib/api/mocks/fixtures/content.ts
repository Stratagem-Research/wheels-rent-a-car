import type { FaqGroup, Itinerary, Review, SiteConfig, Trip } from "@/types/domain";
...
export const FAQS: FaqGroup[] = [
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "Up to 11 months ahead. For same-day pickups, call us — we'll confirm by WhatsApp.",
      },
    ],
  },
  {
    ...
    entries: [
      {
        ...
        answer:
          "At our Hazmieh hub (Gallery Semaan, facing Sea Sweet) or by Address Delivery anywhere in Greater Beirut — including Beirut Airport.",
      },
      {
        id: "f-p-2",
        group: "g-pickup",
        ...
        answer:
          "Our hub is open 08:00–20:00 Monday–Saturday and 10:00–16:00 Sunday. For pickups outside those hours, WhatsApp us — we'll arrange.",
      },
      {
        id: "f-p-3",
        group: "g-pickup",
        ...
        answer:
          "Yes. Choose Address Delivery and enter the airport — we track your flight and meet you at arrivals. Up to 90 minutes' delay is free.",
      },
      {
        id: "f-p-4",
        group: "g-pickup",
  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer:
          "Refundable, varies by car class — typically $300 for economy, up to $1,500 for luxury. Released after return inspection.",
      },
      {
        id: "f-pa-4",
        group: "g-payment",
    ...
    entries: [
      {
        ...
        answer:
          "25 for most cars. 21–24 drivers can rent economy and compact categories with the underage driver add-on.",
      },
      {
        id: "f-d-2",
        group: "g-driver",
        ...
        answer:
          "A valid driver's licence (held ≥ 1 year), a passport or national ID, and a credit card.",
      },
      {
        id: "f-d-3",
        group: "g-driver",
      ...
      },
      {
        ...
        answer:
          "Yes — at booking or at the counter. Each extra driver must also present a valid licence.",
      },
    ],
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        answer: "Yes if cancelled ≥ 24h before pickup. Within 24h, a one-day rate fee applies.",
      },
      {
        id: "f-c-3",
        group: "g-cancel",
        ...
        answer:
          "Card refunds clear in 3–10 business days depending on your bank. Cash bookings have no refund (we never charged you).",
      },
    ],
  },
  {
...
/**
 * Default self-drive trip articles (Phase 12 — Trips/Blog surface).
 *
 * Seeds the homepage Explore Lebanon carousel, the /trips listing page,
 * and per-article /trips/[slug] pages. Admin CRUD writes overlay these
 * defaults via lib/admin/store.ts (commit 6). Image paths point at
 * placeholders inside public/images/Trips Images/ — the client supplies
 * the final cinematic photography later.
 */
...
Most visitors pair the Cedars with the Gibran Museum in Bcharre, a Maronite history detour, or a coffee stop at the Saydet El Hosn shrine perched above the valley.`,
  ...
  },
  {
    ...
    title: "Baalbek & Anjar",
    excerpt:
      "Roman temples at Baalbek and the Umayyad palace city of Anjar — a Bekaa Valley double-header.",
    coverImage: {
    ...
    meta: "9h · Sedan recommended",
    region: "bekaa",
    body: `Baalbek's Temple of Jupiter is the largest Roman temple ever built — its six standing columns are 22m tall. Allow two hours on the site, then drive 40 minutes south to Anjar's Umayyad palace city for a quieter, equally substantial ruin.

The Bekaa Valley between the two is wine country: Château Ksara, Domaine Wardy, and Château Kefraya all offer cellar visits and tastings if you book ahead. Many travellers add a Bekaa lunch (mezza at Tawlet Ammiq) before turning back to Beirut via the Dahr el Baidar pass.

A comfortable sedan handles the route well — the Bekaa is largely flat once you're past the mountain pass.`,
  ...
  },
  {
    ...
    title: "Tyre & Sidon",
    excerpt:
      "Phoenician harbours, Mamluk souks, and a seafood lunch at Tyre's old port — south coast in a day.",
    coverImage: {
...
A sedan handles the route easily. If you have an extra day, add Maghdouché (the Lady of Mantara shrine) on the return for the view of the Sidon coast.`,
    suggestedVehicleCategory: "sedan",
  ...
  },
  {
    ...
    meta: "7h · Any car",
    region: "coast",
    body: `Byblos (Jbeil) is the easiest day trip from Beirut — 35 minutes on the coastal highway. The Phoenician harbour, the Crusader castle, and the old souk loop in three hours. Lunch at Pepe Abed in the old port is the classic move.
...
Add Batroun on the way back: the seafront, the Phoenician wall, and a Hilmi's lemonade are the standard programme.`,
  ...
  },
  {
    ...
    meta: "8h · SUV recommended",
    region: "mountains",
    body: `The Chouf Cedar Reserve is Lebanon's largest cedar stand — a series of trails ranging from 30 minutes to a full-day hike. Beiteddine Palace, 30 minutes away, is the country's best-preserved 19th-century palace and hosts the Beiteddine Festival in summer.

The route is full of switchbacks; an SUV is more comfortable, though a sedan handles it in good weather. Lunch options include the seasonal restaurants in Deir el Qamar — try the kibbeh nayyeh.`,
    suggestedVehicleCategory: "suv",
  ...
  },
  {
    ...
    excerpt:
      "Maronite monasteries carved into a sandstone gorge — one of Lebanon's most cinematic drives.",
    coverImage: {
      src: "/images/Trips Images/south lebanon.jpg",
...
/**
 * Default chauffeur-led itineraries (Phase 12 — Sample Itineraries surface).
 *
...
export const ITINERARIES: Itinerary[] = [
  ...
  },
  {
    ...
    schedule: [
      ...
      { time: "16:30", title: "Château Ksara cellar tour" },
